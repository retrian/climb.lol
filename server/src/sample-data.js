      ...
      players: [
        {
          ...
          socials: [
            {
              label: "twitch.tv/skyhook",
              url: "https://twitch.tv/skyhook"
            },
            {
              label: "x.com/skyhook",
              url: "https://x.com/skyhook"
            }
          ],
          socialsSummary: "Mid • Twitch linked"
        },
        {
          riotId: "Nova#NA1",
          ...
          socials: [
            {
              label: "twitch.tv/nova",
              url: "https://twitch.tv/nova"
            }
          ],
          socialsSummary: "Jungle • X linked"
        }
      ],
      latestGames: [
        {
